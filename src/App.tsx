      ...
      <CurrencyProvider>
        <CartProvider>
          <div className="min-h-screen bg-gray-50">
            ...
            <footer className="bg-gradient-to-br from-brand-950 via-brand-900 to-brand-800 text-white py-16 mt-24 relative overflow-hidden font-sans border-t border-brand-800">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                  <div>
                    <h3 className="text-3xl font-serif font-bold bg-gradient-to-r from-accent-400 to-accent-200 bg-clip-text text-transparent mb-4 tracking-tight">
                      ThriftySouq
                    </h3>
                    ...
                    <div className="flex gap-4">
                      <a href="https://facebook.com/thriftysouq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-accent-500/20 rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1 text-gray-400 hover:text-accent-400 border border-white/10 shadow-soft">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                        </svg>
                      </a>

                      <a href="https://wa.me/971501234567" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-accent-500/20 rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1 text-gray-400 hover:text-accent-400 border border-white/10 shadow-soft">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <a href="https://instagram.com/thriftysouq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-accent-500/20 rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1 text-gray-400 hover:text-accent-400 border border-white/10 shadow-soft">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {footerSections.map((section) => (
                    <div key={section.id}>
                      <h4 className="font-serif font-medium text-lg mb-4 text-accent-100">{section.title}</h4>
                          ...
                          .map((link) => (
                            <li key={link.id}>
                              <button
                                ...
                                className="hover:text-accent-400 transition-colors text-left font-light"
                              >
                                {link.label}
                              </button>
                            </li>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 mt-8">
                  <p className="text-gray-400/80 text-sm font-light">
                    &copy; {new Date().getFullYear()} ThriftySouq. All rights reserved. Dubai, UAE.
                  </p>
                  <button
                    onClick={() => {
                    ...
                    className="px-5 py-2.5 bg-white/5 hover:bg-white/10 text-white font-medium rounded-xl border border-white/10 transition-all duration-300 shadow-soft"
                  >
                    Admin Dashboard
                  </button>
                </div>
