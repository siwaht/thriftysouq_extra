    ...
    <CurrencyProvider>
      <CartProvider>
        <div className="min-h-screen bg-gray-50">
          ...
          <footer className="bg-hero-gradient text-white pt-24 pb-12 mt-32 relative overflow-hidden">
            {/* Background Texture */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
              <div className="grid md:grid-cols-4 gap-12 lg:gap-16 mb-20">
                <div className="col-span-1 md:col-span-2 lg:col-span-1">
                  ...
                  <div className="flex gap-4">
                    <a href="https://facebook.com/thriftysouq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gold-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:text-white text-brand-100">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                      </svg>
                    </a>
                    <a href="https://wa.me/971501234567" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gold-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:text-white text-brand-100">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://instagram.com/thriftysouq" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gold-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:text-white text-brand-100">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {footerSections.map((section) => (
                  <div key={section.id}>
                    <h4 className="font-bold text-lg mb-6 text-gold-400 font-serif tracking-wide">{section.title}</h4>
                        ...
                        .map((link) => (
                          <li key={link.id}>
                            <button
                              ...
                              className="hover:text-gold-400 transition-colors text-left flex items-center gap-2 group"
                            >
              ...
              <div className="border-t border-brand-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-brand-900/50 hover:bg-brand-800 text-brand-200 hover:text-white text-sm font-medium rounded-lg transition-all duration-300 border border-brand-700 hover:border-brand-600"
                >
                  Admin Dashboard
                </button>
              </div>
